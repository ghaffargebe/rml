                  ...
                  <div class="x_content" ng-app="">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      @endif
                        ...
                        <div class="row">
                          <a class="btn btn-primary" href="{{ url('/organisasi/create')}}" role="button"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Instansi</a>
                      	</div>
                      	@endif
        ...
        <script type="text/javascript">
          ...
          $(document).on("click", ".btn-delete", function (e){
            ...
            swal({
              ...
              text: "Anda akan menghapus salah satu Instansi!",
              type: "warning",
            ...
            function(isConfirm){
              if (isConfirm) {
                 ...
                 swal("Deleted!", "Data Instansi Berhasil Dihapus", "success");
                 setTimeout(function() {
